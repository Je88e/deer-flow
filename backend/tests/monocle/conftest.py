"""Fixtures for the WitAI Monocle behavioural tests.
...
def run_agent() -> Callable[[str], str]:
    ...
    Skips unless ``MONOCLE_LIVE_TESTS=1`` is set, when the WitAI app is not
    ...
    pytest.importorskip("deerflow", reason="WitAI app not importable in this venv")

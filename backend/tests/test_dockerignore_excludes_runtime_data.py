...
into the image. The runtime directories are written by a *running* WitAI, not by
...
host that has run WitAI bakes that state — including the JWT secret and the user

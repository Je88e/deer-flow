...
INTERNAL_AUTH_HEADER_NAME = "X-WitAI-Internal-Token"
INTERNAL_OWNER_USER_ID_HEADER_NAME = "X-WitAI-Owner-User-Id"
...
def get_internal_user(owner_user_id: str | None = None):
    ...
    ``X-WitAI-Owner-User-Id`` header), the synthetic user's ``.id``

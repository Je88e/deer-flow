...
``langchain_openai.ChatOpenAI`` currently ignores that field, so WitAI's
...
which WitAI already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        WitAI middlewares tag user messages with internal provenance names

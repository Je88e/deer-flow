"""``E2BSandboxProvider`` — WitAI :class:`SandboxProvider` for e2b cloud.
...
class E2BSandboxProvider(SandboxProvider):
    ...
    def __init__(self) -> None:
        ...
        # Active sandboxes, keyed by WitAI-side sandbox id (== e2b id).
    ...
    def _create_sandbox(self, thread_id: str | None, *, user_id: str) -> str:
        ...
        # Materialise WitAI's virtual path layout (/mnt/user-data/...) inside
    ...
    def _bootstrap_sandbox_paths(self, client: E2BClientSandbox) -> None:
        """Materialise WitAI's virtual path layout inside the e2b VM.
    ...
    def _sync_outputs_to_host(
        ...
        *,
        ...
        WitAI's ``/api/threads/{tid}/artifacts/...`` endpoint resolves

"""Minimal asynchronous client for the LightRAG APIs WitAI consumes."""
...
class LightRAGClient:
    """Direct HTTP client for WitAI's read-only retrieval tools.
    ...
    async def query_data(
        ...
        *,
        ...
        read-only shape WitAI's knowledge tool consumes.
        """

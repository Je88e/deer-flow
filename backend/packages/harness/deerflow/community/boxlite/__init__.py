"""BoxLite micro-VM backend for WitAI sandboxes.
...
macOS) — behind WitAI's :class:`Sandbox` / :class:`SandboxProvider` contract.
...
virtualization when WitAI itself runs inside a cloud VM); macOS uses

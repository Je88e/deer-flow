...
def _canonical_peer_id(
    ...
    """Map WitAI's case-insensitive agent names to disjoint peer IDs."""
...
def _session_id(
    ...
    """Derive one stable OpenViking session for one WitAI thread."""
...
def _captureable_messages(
    ...
    """Drop WitAI-only injected context before handing messages to OpenViking."""

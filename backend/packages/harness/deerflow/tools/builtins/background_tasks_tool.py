...
async def cancel_background_task(
    ...
    task: Annotated[
        str | None,
        "Optional exact task name or WitAI task ID. Omit it only when one active task exists.",
    ] = None,
) -> dict[str, Any]:
    ...
    return {
        ...
        "task": public,
        "message": "Cancellation requested. WitAI will keep retrying safely if the remote server is temporarily unavailable.",
    }

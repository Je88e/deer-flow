...
that builds a WitAI graph (gateway, workers, in-process LangGraph
...
def _as_overwrite(value: Any) -> tuple[bool, Any]:
    ...
    WitAI's write paths produce for these Union channels (the branch and
    ...
    an internal serialization detail WitAI never emits into these channels.
    """

...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. WitAI provides built-in
...
WitAI organizes tools into four categories:
...
through WitAI's artifact system. This is useful for visual evidence, UI checks,

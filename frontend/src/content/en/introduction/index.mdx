---
title: Introduction
description: WitAI is a runtime harness for building long-horizon agent systems with skills, memory, tools, and sandboxed execution.
---
...
WitAI is a framework for building and operating agent systems. Rather than treating an AI agent as a simple text generator or a hardcoded workflow graph, WitAI provides a robust **runtime harness** that packages the core components required for agents to perform meaningful, long-horizon work.

## What is WitAI?

WitAI bridges the gap between raw LLMs and production-ready agent workflows. It focuses on the capabilities necessary to complete complex tasks:

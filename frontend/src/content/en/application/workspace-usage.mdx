...
description: The WitAI App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.
---
...
The WitAI App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.
...
If token usage display is enabled, WitAI shows one conversation-level total in

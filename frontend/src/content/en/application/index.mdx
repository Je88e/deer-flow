---
title: WitAI App
description: WitAI App is the reference implementation of what a production WitAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  WitAI App is a complete Super Agent application built on top of WitAI
...
WitAI App is the reference implementation of what a production WitAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The WitAI App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, WitAI Harness                               |
| Reverse proxy     | nginx                                                                |

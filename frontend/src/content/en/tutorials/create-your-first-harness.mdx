...
description: This tutorial shows you how to use the WitAI Harness programmatically — importing and using WitAI directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the WitAI Harness programmatically — importing and using WitAI directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- WitAI repository cloned

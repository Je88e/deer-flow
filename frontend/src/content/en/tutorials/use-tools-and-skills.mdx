...
description: This tutorial shows you how to configure and use tools and skills in WitAI to give the agent access to web search, file operations, and domain-specific capabilities.
---
...
This tutorial shows you how to configure and use tools and skills in WitAI to give the agent access to web search, file operations, and domain-specific capabilities.

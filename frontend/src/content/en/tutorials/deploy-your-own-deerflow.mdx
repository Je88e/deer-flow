...
description: This tutorial guides you through deploying WitAI to a production environment using Docker Compose for multi-user access.
---

import { Callout, Steps } from "nextra/components";

# Deploy Your Own WitAI

This tutorial guides you through deploying WitAI to a production environment using Docker Compose for multi-user access.

---
title: 简介
description: WitAI 是一个运行时 Harness，用于构建支持技能、记忆、工具和沙箱执行的长时序 Agent 系统。
---
...
WitAI 是一个用于构建和运行 Agent 系统的框架。与将 AI Agent 视为简单的文本生成器或硬编码的工作流图不同，WitAI 提供了一个强大的 **运行时 Harness**，打包了 Agent 执行有意义的长时序工作所需的核心组件。

## 什么是 WitAI？

WitAI 弥补了原生 LLM 与生产级 Agent 工作流之间的差距。它专注于完成复杂任务所需的关键能力：
...
<Cards num={3}>
  <Cards.Card title="为什么选择 WitAI" href="/docs/introduction/why-deerflow" />

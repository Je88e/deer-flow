...
export const zhCN: Translations = {
  ...
  capabilities: {
    ...
    sharedSkills: "共享技能",
    title: "能力中心",
    description: "为你的工作添加工具与技能，让 WitAI 更懂你的工作方式。",
    plugins: "插件",
    skills: "技能",
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 🦌 WitAI，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nDeerFlow 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放潜力。通过自定义技能可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  backgroundTasks: {
    ...
    cancellationRetrying: (attempt) =>
      `第 ${attempt} 次取消失败；WitAI 将继续重试。`,
    notificationRetrying: (attempt) =>
      `第 ${attempt} 次聊天通知失败；WitAI 将退避后重试。`,
    notificationStopped: "聊天通知因反复失败或永久拒绝，已停止重试。",
    trackingDegraded: "状态检查有所延迟，WitAI 仍在重试。",
    viewDetails: "查看详情",
    hideDetails: "收起详情",
  ...
  scheduledTasks: {
    ...
    context: {
      ...
      reuseNoticeDescription:
        "如果触发时该线程正在运行，WitAI 会将本次执行排队，并在线程空闲后启动；超过配置的最长等待时间后会标记为失败。",
    },
    search: {
  ...
  agents: {
    ...
    save: "保存智能体",
    saving: "正在保存智能体...",
    saveRequested: "已提交保存请求，正在根据当前对话生成并保存初版智能体。",
    saveHint:
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 WitAI 官方网站",
    githubTooltip: "访问 WitAI 的 GitHub 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 WitAI",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 WitAI",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      buzz: "通过 WitAI 智能体接收 Buzz 频道消息和私聊。",
      telegram: "接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "接收 Discord 服务器消息。",
      feishu: "接收飞书和 Lark 消息。",
      dingtalk: "接收钉钉 Stream Push 消息。",
      wechat: "接收微信 iLink 消息。",
      wecom: "接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可使用",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 WitAI 的界面和行为。",
    models: {
      title: "模型",
    ...
    memory: {
      title: "记忆",
      description:
        "应用会在后台不断从你的对话中自动学习。这些记忆能帮助我们更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
  ...
  "mcpServers": {
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向应用发送消息的即时通讯账号。",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "把你的 WitAI 账号指向另一个 Lark/飞书 App。只影响你自己的账号，不影响其他用户。",
        ...
        authStarted: "授权页已打开，WitAI 会自动检测授权结果。",
        authorizationStillPending:
          "还没有检测到授权完成。请在浏览器完成授权；WitAI 会继续自动检测。如果页面没有更新，可点击“我已完成授权”。",
        ...
        openAuthLinkDescription:
          "打开下面的链接完成授权。WitAI 会持续自动检测，并在授权通过后保存连接状态。",
        waitingAuthTitle: "等待飞书授权完成",
        waitingAuthDescription:
          "请在刚打开的浏览器页面完成授权。WitAI 会自动更新这里的状态；下方按钮只是兜底操作。",
        openAuthLink: "打开链接",
        copyAuthLink: "复制链接",
        completeAuth: "我已完成授权",
        ...
        authNextDescription:
          "点击“连接飞书”后，WitAI 会先检查当前状态；未连接或授权过期时会拉起浏览器授权。",
      },
    },
    skills: {
    ...
    notification: {
      title: "通知",
      description:
        "只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
